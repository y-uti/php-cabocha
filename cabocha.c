...
#define PHP_CABOCHA_REGISTER_CONSTANT(name) \
    ...
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_EUC_JP);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_CP932);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_UTF8);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_ASCII);

    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_IPA);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_JUMAN);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_UNIDIC);

    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_TREE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_LATTICE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_TREE_LATTICE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_XML);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_CONLL);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_FORMAT_NONE);

    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_INPUT_RAW_SENTENCE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_INPUT_POS);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_INPUT_CHUNK);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_INPUT_SELECTION);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_INPUT_DEP);

    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_OUTPUT_RAW_SENTENCE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_OUTPUT_POS);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_OUTPUT_CHUNK);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_OUTPUT_SELECTION);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_OUTPUT_DEP);

    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_TRAIN_NE);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_TRAIN_CHUNK);
    PHP_CABOCHA_REGISTER_CONSTANT(CABOCHA_TRAIN_DEP);

#undef PHP_CABOCHA_REGISTER_CONSTANT
